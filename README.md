...
do local GUI = game.CoreGui:FindFirstChild("Better");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
function BetterX:ToggleUi()
if game.CoreGui:FindFirstChild("Better").Enabled == true then -- oh am dumb
game.CoreGui:FindFirstChild("Better").Enabled = false
else
game.CoreGui:FindFirstChild("Better").Enabled = true
end
end

function BetterX:Window(text,gamenme,logo,keybind)
    local hubname = text
	...
	local Better = Instance.new("ScreenGui") -- guess i am using hubname wrong
	Better.Name = "Better" -- wait
	Better.Parent = game.CoreGui
	Better.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
